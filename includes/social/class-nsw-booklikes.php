...
/**
 * Get BookLikes Followers
 *
 * @package   naked-social-widget
 * @copyright Copyright (c) 2016, Nose Graze Ltd.
 * @license   GPL2+
 */
class NSW_BookLikes extends Naked_Social_Widget_Site {
	...
	protected function set_api_url() {
		...
		$url = 'https://www.nosegraze.com/ubb/blapi.php';
	...
	public function get_followers() {
		...
		if ( ! $body->success || $body->success != true || ! $body->followers || $body->followers == 0 ) {
			return false;
		}
